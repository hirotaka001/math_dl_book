...
plt.savefig('scatter_chapter9.png')
...
plt.savefig('learning_curve_loss_chapter9.png')
...
plt.savefig('learning_curve_accuracy_chapter9.png')
...
plt.ylabel('loss', fontsize=14)
plt.title('iter vs loss', fontsize=14)
plt.savefig('learning_curve_loss_4D_chapter9.png')
...
plt.ylabel('accuracy', fontsize=14)
plt.title('iter vs accuracy', fontsize=14)
plt.savefig('learning_curve_accuracy_4D_chapter9.png')